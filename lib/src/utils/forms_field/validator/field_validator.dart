...
static FormFieldValidator<String> numberOnlyValidator({String errorMessage}){
  ...
  static FormFieldValidator<String> qtyValidator({String errorMessage, int minLength, maxLength, minimumQuantity, String minLengthMessage}){
    return (text){
      ...
      {
        minLengthMessage = minLengthMessage == null ? "Minimum amount $minLength)" : minLengthMessage;
...
//      }
      if(minimumQuantity != null && minimumQuantity < 1)
        {
          minLengthMessage = minLengthMessage == null ? "minimum amount $minimumQuantity)" : minLengthMessage;
          return minLengthMessage;
        }
      return null;
    };
